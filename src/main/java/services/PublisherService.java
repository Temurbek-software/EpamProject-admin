...
public class PublisherService {
    ...
    public Publisher getPublisherById(long id) {
        ...
        try (
                Connection connection = DB.getConnection();
                PreparedStatement preparedStatement = connection.prepareStatement(GET_PUBLISHER_BY_ID)) {
    ...
    public int savePublisher(Publisher publisher) {
        ...
        try (Connection connection = DB.getConnection();
            ...
            preparedStatement.setString(3, publisher.getDescription());
            preparedStatement.setString(4, publisher.getPhoneNumber());
            preparedStatement.setString(5, publisher.getEmail());
            preparedStatement.setString(6, publisher.getPassword());
    ...
    public boolean validate(PublisherDto publisherDto) {
        ...
        try (
                Connection connection = DB.getConnection();
                PreparedStatement preparedStatement = connection.prepareStatement("SELECT id, \"nameOfCompany\", address, description, phonenumber, email, password, created_at, updated_at, username\n" +
                "\tFROM public.publisher" +
    ...
    public Publisher getPublisher(PublisherDto publisherDto) {
        ...
        try (
                ...
                PreparedStatement preparedStatement = connection.prepareStatement("SELECT id, " +
                        "\"nameOfCompany\", address, description, phonenumber, email, password," +
                        " created_at, updated_at, \"isBlocked\", username\n" +
            ...
            while (rs.next()) {
                ...
                publisher.setBlocked(rs.getBoolean("isBlocked"));
